...
const calculClass = ({ className }: any) => {
	return cn(
		"bg-cyan-800 p-3 text-white rounded border border-cyan-900 py-2 px-4 border  shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
		className,
	);
};
					...
					<div className='justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'>
						<div
							...
							<div className='border-0  shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
								...
								{/*footer*/}
								<div className='flex items-center justify-end p-6 border-t border-solid border-slate-200 '></div>
							</div>
						</div>
					</div>
