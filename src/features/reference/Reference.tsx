...
const Reference = ({ type }: ReferenceProps) => {
  switch (type) {
    case "coco":
      return (
        <List avatar={false} rectoVerso={false} displayedIncheck={{msg:"",css:"",tab:[]}}
          title="test coco"
          mal={false}
          body={[
            {
          ...
          body={[
            {
              ...
              displayed:true,join: "nodisplayed:true,join",
            },
            {
              label: "Nomenclature",
              attr: "nomenclature",
            ...
            },
            {
              ...
              css: "w-1/2 float-left",
              path: "rawMaterials",
              displayed:true,join: "rawMaterials",
            },
            {
              ...
              css: "w-1/2 float-left",
              path: "unitMeasures",
              displayed:true,join: "unitMeasures",
            },
            {
              label: "Taux de perte",
              attr: "tauxPertes",
